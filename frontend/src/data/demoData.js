...
#AI #DesarrolloSoftware #Claude #Anthropic #LLM`,
    ...
    tokens_input: 387,
    tokens_output: 312,
    generation_cost_usd: 0.000123,
    prompt_used: `Eres un experto en marketing de contenidos en LinkedIn con 10 años de experiencia.\nCrea un post profesional para LinkedIn basado en esta tendencia.\n\nTendencia: Claude 3.5 Sonnet supera a GPT-4o en benchmarks de código\nContexto: Anthropic lanza modelo con mejoras en razonamiento y velocidad de respuesta.\nFuente: https://anthropic.com\n\nFORMATO DE RESPUESTA (respeta exactamente):\nTITULO: [título interno de máximo 8 palabras]\n---\n[cuerpo del post]\n\nREGLAS DEL CUERPO:\n- Gancho impactante en la primera línea\n- 3-4 puntos clave con viñetas\n- Reflexión personal al final\n- Pregunta para comentarios\n- 3-5 hashtags\n- Tono profesional pero cercano\n- Máximo 1200 caracteres`,
  },
  {
    id: 202,
...
Llama 3.1 405B marca el inicio de una nueva era donde la IA de calidad enterprise es accesible para organizaciones de cualquier tamaño.`,
    ...
    tokens_input: 412,
    tokens_output: 891,
    generation_cost_usd: 0.000298,
    prompt_used: `Eres un escritor técnico experto en tecnología, IA y startups.\nCrea un artículo de blog completo en formato Markdown.\n\nTendencia: Llama 3.1 405B disponible en Meta AI\nContexto: Meta libera su modelo más poderoso bajo licencia comercial.\nFuente: https://reddit.com/r/MachineLearning\n\nINSTRUCCIONES:\n- Primera línea: título SEO como H1\n- Introducción que enganche (2-3 párrafos)\n- 3-4 secciones con subtítulos H2\n- Al menos una lista con puntos clave\n- Sección "¿Por qué importa esto?"\n- Conclusión con takeaways accionables\n- Entre 600-900 palabras\n- Escribe en español`,
  },
  {
    id: 203,
